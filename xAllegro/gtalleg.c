/*
 * $Id: gtalleg.c 13577 2010-01-14 17:59:30Z vszakats $
 */
...
//         iRet = al_set_gfx_mode( AL_GFX_AUTODETECT, iWidth, iHeight, 0, 0 );
         ...
         iRet = al_set_gfx_mode( nModo, num_col, num_lin, 0, 0 );
      }
//      if( iRet != 0 )
//      {
...
{ 
   ...
   scare_mouse();
   ssfDrawText( screen, &s_ssfDefaultFont, cBuf, iLeft, iTop, iColor );
   unscare_mouse();
}
